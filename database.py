...
def create_default_expeditions():
    ...
    defaults = [
        ...
        {
            'name': 'Forest Trial',
            'levels': ['EN018', 'EN019', 'EN020'],
            'description': 'Treacherous woods filled with cunning foes.',
            'drops': 'IT007:60,IT008:60',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Cavern of Echoes',
            'levels': ['EN021', 'EN006', 'EN009'],
            'description': 'Deep caves resonate with danger.',
            'drops': 'IT009:50,IT010:50',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Frozen Nightmare',
            'levels': ['EN011', 'EN022', 'EN013'],
            'description': 'Only the toughest survive the biting cold.',
            'drops': 'IT011:30,IT013:20',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Inferno March',
            'levels': ['EN012', 'EN024', 'EN021'],
            'description': 'A relentless onslaught of flame and fury.',
            'drops': 'IT014:25,IT015:25',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Lost Empire',
            'levels': ['EN014', 'EN015', 'EN025'],
            'description': 'Ruins hide foes of a bygone age.',
            'drops': 'IT016:20',
            'image_file': None,
            'image_res': None,
        },
        {
            ...
            'levels': ['EN017', 'EN014', 'EN022'],
            'description': 'Lightning strikes those who enter.',
            'drops': 'IT013:30,IT015:30',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Underworld Gate',
            'levels': ['EN008', 'EN009', 'EN015'],
            'description': 'Demons lurk beyond the gate.',
            'drops': 'IT014:35,IT016:25',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Mythic Sanctuary',
            'levels': ['EN023', 'EN024', 'EN025'],
            'description': 'Ancient guardians protect priceless relics.',
            'drops': 'IT017:20',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Eternal Conflux',
            'levels': ['EN013', 'EN014', 'EN023'],
            'description': 'Reality twists and turns endlessly here.',
            'drops': 'IT015:30,IT017:15',
            'image_file': None,
            'image_res': None,
        },
        {
            'name': 'Astral Chaos',
            'levels': ['EN024', 'EN025', 'EN015'],
            'description': 'Face the most powerful beings of the realm.',
            'drops': 'IT016:30,IT017:25',
            'image_file': None,
            'image_res': None,
        },
    ]
